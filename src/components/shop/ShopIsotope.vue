    ...
    <div class="flex-w flex-sb-m p-b-52">
      <div class="flex-w flex-l-m filter-tope-group m-tb-10">
        <button
          ...
          class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 text-caps"
          v-bind:class="{ 'how-active1': filterOption == key }"
          @click="filter(key)"
        >
          {{ key }}
        </button>
      ...
      <!-- Filter -->
      <div class="panel-filter w-full p-t-10" v-show="filterToggleStatus">
        <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
          ...
          <div class="filter-col4 p-b-27">
            ...
            <div class="flex-w p-t-4 m-r--5">
              ...
              <a
                href="#"
                class="flex-c-m stext-107 cl6 size-301 bor7 p-lr-15 hov-tag1 hov-tag1-active trans-04 m-r-5 m-b-5"
              >
                Lifestyle
              </a>
              <a
